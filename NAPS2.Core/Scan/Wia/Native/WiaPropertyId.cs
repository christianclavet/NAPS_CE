...
namespace NAPS2.Scan.Wia.Native
{
    ...
    public static class WiaPropertyId
    {
        ...
        public const int IPS_PAGES_SIZE = 3097;
        public const int IPS_AUTO_DESKEW = 3107;
        public const int IPS_MULTI_FEED = 4168;
        public const int IPS_MULTI_FEED_DETECT_METHOD = 4193;
        public const int IPS_MULTI_FEED_SENSITIVITY = 4169;
