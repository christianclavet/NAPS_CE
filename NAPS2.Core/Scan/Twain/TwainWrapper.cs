...
namespace NAPS2.Scan.Twain
{
    public class TwainWrapper
    {
        ...
        internal void Scan(IWin32Window dialogParent, ScanDevice scanDevice, ScanProfile scanProfile, ScanParams scanParams, CancellationToken cancelToken, ScannedImageSource.Concrete source, Action<ScannedImage, ScanParams, string, bool> runBackgroundOcr)
        {
