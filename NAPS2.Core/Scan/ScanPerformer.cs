...
namespace NAPS2.Scan
{
    ...
    public class ScanPerformer : IScanPerformer
    {
        ...
        public async Task PerformScan(ScanProfile scanProfile, ScanParams scanParams, IWin32Window dialogParent,
            ...
            try
            {
                ...
                if (doAutoSave)
                {
                    if (scanProfile.AutoSaveSettings.ClearImagesAfterSaving)
                    {
                        ...
                        if (await autoSave.Save(scanProfile.AutoSaveSettings, images))
                        {
                    ...
                    else
                    {
                        ...
                        await autoSave.Save(scanProfile.AutoSaveSettings, images);
                    }
                }
                else
                {
